...
export default function NormalizedEstimations({
  names,
  ...
  const alternativesNormalizedEstimationsRows = tableData.map(
    (row, rowIndex) => (
      <TableRow key={rowIndex}>
        ...
        {transposed
          ? row.alternatives.map((alternative, altIndex) => (
              ...
              >
                {renderLinguisticTerms(
                  alternativesNormalizedEstimations[alternative.itemId]
                )}
              </TableCell>
            ))
          : row.criteria.map((criterion, critIndex) => (
              ...
              >
                {renderLinguisticTerms(
                  alternativesNormalizedEstimations[criterion.itemId]
                )}
              </TableCell>
            ))}
      </TableRow>
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Typography variant="h5">Normalized estimations</Typography>
        ...
        <TableContainer component={Paper}>
          <Table>
            ...
            <TableBody>{alternativesNormalizedEstimationsRows}</TableBody>
          </Table>
        </TableContainer>
      </Box>
    </>
